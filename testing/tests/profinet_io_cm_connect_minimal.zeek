...
# @TEST-EXEC: zeek -C -r ${TRACES}/profinet_io_cm_connect_minimal.pcapng ${PACKAGE} %INPUT
...
#
# @TEST-DOC: Test profinet-io-cm analyzer with profinet_io_cm_connect_minimal.pcapng
